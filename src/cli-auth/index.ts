 ...
 * Cheap web app login page, and waits for the token to be delivered
...
export interface BrowserAuthOptions {
	/** Base URL of the Cheap web app (default: https://app.cheap.dev) */
	webAppUrl?: string
...
/**
 * Authenticate via browser.  The user is redirected to the Cheap web
...
export async function authenticateViaBrowser(options: BrowserAuthOptions = {}): Promise<BrowserAuthResult> {
	const webAppUrl = options.webAppUrl ?? envConfig.CHEAP_WEB_APP_URL
