...
type PatchableAgentSession = {
	prototype: {
		...
		_cheapCloudflare524RetryPatch?: boolean
	}
}
 ...
 * but not Cloudflare's 524 timeout, which cheap-dev's gateway can return for a
...
export function installCloudflare524RetryPatch(
	...
	if (proto._cheapCloudflare524RetryPatch) return
	...
	proto._cheapCloudflare524RetryPatch = true
}
