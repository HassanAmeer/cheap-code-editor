...
const INSTALLED = Symbol.for("cheap.piNativeCompat.installed")
const NORMALIZED = Symbol.for("cheap.piNativeCompat.normalized")
const WRAPPED = Symbol.for("cheap.piNativeCompat.wrapped")
const ORIGINAL_GET_EXTENSIONS = Symbol.for("cheap.piNativeCompat.originalGetExtensions")
const ORIGINAL_GET_SKILLS = Symbol.for("cheap.piNativeCompat.originalGetSkills")
const ORIGINAL_GET_PROMPTS = Symbol.for("cheap.piNativeCompat.originalGetPrompts")
const ORIGINAL_GET_THEMES = Symbol.for("cheap.piNativeCompat.originalGetThemes")
const ORIGINAL_PACKAGE_RESOLVE = Symbol.for("cheap.piNativeCompat.originalPackageResolve")
