...
const USER_CONFIG_PATH = resolve(homedir(), ".config", "cheap", "harness", "permissions.json")
const PROJECT_CONFIG_SUFFIX = join(".cheap", "permissions.json")
const LOCAL_CONFIG_SUFFIX = join(".cheap", "permissions.local.json")
