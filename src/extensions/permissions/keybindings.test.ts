...
import { writeCheapKeybindingDefaults } from "./keybindings.js"
...
describe("writeCheapKeybindingDefaults", () => {
	it("creates keybindings.json with shift+tab unbound and ctrl+j newline fallback", () => {
		...
		writeCheapKeybindingDefaults(testDir)
	...
	it("handles malformed existing keybindings.json gracefully", () => {
		...
		// Should not throw
		expect(() => writeCheapKeybindingDefaults(testDir)).not.toThrow()
