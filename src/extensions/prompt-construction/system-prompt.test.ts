...
const testEnv: EnvironmentInfo = {
	...
	documentsDir: "/home/testuser/projects/myapp/.cheap/docs",
	...
	it("prints stable environment context lines", () => {
		expect(formatEnvironmentSection(testEnv)).toBe(
			[
				...
				'- Documents directory: "/home/testuser/projects/myapp/.cheap/docs"',
...
describe("buildSystemPrompt", () => {
	...
	describe("orchestrator mode", () => {
		it("includes all expected sections", () => {
			...
			expect(result).toContain("You are Cheap, an AI coding agent")
		...
		it("places global context files before project context files", () => {
			const contextFiles = [
				{ path: "/home/testuser/.config/cheap/harness/AGENTS.md", content: "Global rule" },
