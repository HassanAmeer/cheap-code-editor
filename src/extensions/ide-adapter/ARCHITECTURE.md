...
Internal documentation for Cheap contributors working on the `ide-adapter` extension.
...
Cheap starts or opens a new session
...
User selects code and clicks "Send to Cheap"
