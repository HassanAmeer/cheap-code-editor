...
export const CHEAP_COAUTHOR = "Co-Authored-By: Cheap <noreply@cheap.dev>"
...
- **Git commits**: Always end every commit message with a blank line followed by \`${CHEAP_COAUTHOR}\`.`
