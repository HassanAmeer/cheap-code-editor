 ...
 *
 * Creates /tmp/cheap/{sessionId}.sock as a net.Server when running inside a
 * sandbox cluster (detected via isInSandboxCluster(): CHEAP_SANDBOX=1 or both
 ...
 * the cheap-sandbox-worker sidecar).
 *
