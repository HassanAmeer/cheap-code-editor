...
const GITHUB_ISSUES_BASE = "https://github.com/getcheap/cheap/issues/new"
...
const BUG_COMMAND_CONFIG = {
	description: "Report a bug in cheap — opens GitHub issue form",
