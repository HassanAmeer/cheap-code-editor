 ...
 *   1. Package: each installed cheap extension's <pkg>/agents/*.md (lowest)
 *   2. Global:  $CHEAP_CODING_AGENT_DIR/agents/*.md (default: ~/.config/cheap/harness/agents/*.md)
 *   3. Project: <cwd>/.cheap/agents/*.md (highest — overrides everything)
 */
...
export function loadCustomAgents(cwd: string): Map<string, AgentConfig> {
	...
	const projectDir = join(cwd, ".cheap", "agents")
