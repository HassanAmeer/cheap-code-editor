...
export const MAIN_MODEL: CheapModel = {
	slug: "minimax-m3",
...
export const KIMI_K25_MODEL: CheapModel = {
	slug: "kimi-k2.5",
...
export const CODING_MODEL: CheapModel = {
...
export const SUB_MODEL: CheapModel = {
	slug: "minimax-m2.7",
...
export const OPUS_MODEL: CheapModel = {
...
export const SONNET_MODEL: CheapModel = {
...
export const ALL_MODELS: ReadonlyArray<CheapModel> = [
	MAIN_MODEL,
	CODING_MODEL,
	SUB_MODEL,
	OPUS_MODEL,
