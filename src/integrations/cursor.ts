 ...
 * layer. Alias those substrings so Cursor always routes through cheap's gateway
...
/**
 * Mutate Cursor's reactive-storage blob in place to point at the cheap
 ...
 * pre-existing model lists are preserved (cheap models are added
 * uniquely, no clobber).
 *
...
async function writeCursor(
	...
	// bun:sqlite is built into the compiled cheap binary and into `bun run`.
