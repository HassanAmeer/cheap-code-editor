 ...
 * cheap process is single-threaded and there's no second consumer of
 * this file.
 */
...
/** Honors $CHEAP_NO_UPDATE_CHECK=<anything-truthy>. */
export function isUpdateCheckDisabled(): boolean {
	const v = process.env.CHEAP_NO_UPDATE_CHECK
