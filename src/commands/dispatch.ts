...
/**
 * Decide whether a top-level cheap subcommand handles this argv.
 *
...
export async function dispatchSubcommand(args: string[]): Promise<DispatchResult> {
	...
	// `cheap claude --help` is a subcommand call — the handler decides what to do.
	// `cheap --help` (or `cheap -h`) falls here and prints the union view.
