...
/**
 * Print the small cheap banner before launching a tool subcommand
 * (`cheap claude`, `cheap opencode`, …). It states which tool we're
...
export function renderBanner(summary: BannerSummary): string {
	...
	const header = `${BOLD}${RED_OPEN}🌶️  cheap${RST}`
