...
function usage(code: number): number {
	...
	out("Usage: cheap resources [list|status]")
	out("       cheap resources enable <resource-id>")
	out("       cheap resources disable <resource-id>")
	out("       cheap resources set <resource-id> on|off")
	out("       cheap resources reset <resource-id>")
	return code
}
