...
export const COMMANDS: CommandDefinition[] = [
	...
	{ name: "cursor", summary: "Configure Cursor to use Cheap", run: runCursor },
	{ name: "openclaw", summary: "Configure OpenClaw to use Cheap", run: runOpenClaw },
	{ name: "gsd2", summary: "Install / configure GSD2 with Cheap", run: runGsd2 },
