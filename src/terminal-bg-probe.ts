...
// from a consistent base. Defaults to a dark estimate since most cheap users
// run on dark schemes.
...
// Used by cheap-minimal-tints to apply auto-contrast text colors.
...
// BG ANSI color conversion utilities — used by cheap-minimal-tints to apply
