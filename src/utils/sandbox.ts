 ...
 *   1. CHEAP_SANDBOX env var ("1" or "true", case-insensitive) — explicit sentinel set by container orchestrator
...
export function isInSandboxCluster(): boolean {
	if (process.env.CHEAP_SANDBOX === "1" || process.env.CHEAP_SANDBOX?.toLowerCase() === "true") return true
